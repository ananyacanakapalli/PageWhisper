...
PageWhisper is an AI-powered chatbot built with Streamlit, designed to help users query the content of PDF and DOCX documents. Users can upload a document, ask questions, and receive concise, context-aware answers generated by a large language model. The app uses vector similarity search to retrieve relevant information from uploaded documents before passing it to the AI.
